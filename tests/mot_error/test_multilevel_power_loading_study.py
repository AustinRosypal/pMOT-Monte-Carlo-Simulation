...
import pmot.mot_error.power_loading_study as power_study
...
from pmot.mot_error.power_loading_study import (
    COOLING_DETUNING_HZ,
...
def test_analysis_writes_three_plots_and_correct_loading_units(tmp_path) -> None:
    ...
    from pmot.mot_error.power_loading_study import save_samples_atomic
