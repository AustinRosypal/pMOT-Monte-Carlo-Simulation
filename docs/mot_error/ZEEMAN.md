# Archived erroneous-model note

This derivation is retained with the superseded `mot_error` implementation. It
does not validate that implementation's population-rate closure and is not an
authoritative specification for the new solver.
