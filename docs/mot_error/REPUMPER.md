...
> **Archive notice:** this document belongs to the superseded `mot_error`
> implementation. Its transition graph may be useful reference material, but
> its former rate closure is not valid for the rebuilt physical solver.
